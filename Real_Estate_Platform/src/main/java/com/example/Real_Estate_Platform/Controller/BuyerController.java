...
public class BuyerController {
    ...
    public String searchLocation(@RequestParam("bid") int bid, Model model) {
        model.addAttribute("bid", bid);
        return "searchLocation";
    }
    @RequestMapping("/searchLocation")
    public String searchBasedOnLocation(@RequestParam("bid") int bid, @RequestParam("address") String address,Model model) {
    ...
    public String searchArea(@RequestParam("bid") int bid, Model model) {
        model.addAttribute("bid", bid);
        return "searchArea";
    }
    @RequestMapping("/searchArea")
    public String searchBasedOnArea(@RequestParam("bid") int bid,@RequestParam("minArea")double minArea,@RequestParam("maxArea")double maxArea, HttpSession session, Model model) {
    ...
    public String searchPrice(@RequestParam("bid") int bid, Model model) {
        model.addAttribute("bid", bid);
        return "searchPrice";
    }
    @RequestMapping("/searchPrice")
    public String searchBasedOnPrice(@RequestParam("bid") int bid,@RequestParam("minPrice")double minPrice ,@RequestParam("maxPrice")double maxPrice, HttpSession session, Model model) {
    ...
    public String viewBuyerAppointments(@RequestParam("id")int id,@RequestParam("bid") int bid,@RequestParam("address")String address,@RequestParam("minPrice")double minPrice,@RequestParam("maxPrice") double maxPrice,@RequestParam("maxArea")double maxArea,@RequestParam("minArea") double minArea, Model model) {
        List<Appointment> appointments = appointmentService.getAppointmentsByBuyerId(bid);
